        ...
        function e() {
          ...
          try {
            ...
            for (var p = 0; p < d.length; p++) {
              ...
              if (d[p].src === f) return d[p];
              if (f === a && d[p].innerHTML && d[p].innerHTML.trim() === o)
                return d[p];
            }
            return null;
          }
    ...
    fb15: function (e, t, n) {
      ...
      var c = function () {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n("div", { staticClass: "my-button" }, [e._v("我的组件按钮")]);
        },
        u = [],
        f = {
          name: "my-button",
      ...
      var d = a(s, c, u, !1, null, null, null),
        p = d.exports;
      ...
      "undefined" !== typeof window && window.Vue && y(window.Vue);
      var v = { install: y, button: l };
      t["default"] = v;
    },
  });
});
